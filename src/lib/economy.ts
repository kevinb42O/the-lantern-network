...
export const BADGES: BadgeInfo[] = [
  {
    ...
    name: 'Nieuwe Buur',
    emoji: '🌱',
    description: 'Net begonnen in de buurt',
    minFlares: 0,
    color: 'text-gray-400',
  ...
  },
  {
    ...
    name: 'Buurthelper',
    emoji: '🤝',
    description: 'Heeft al wat keren geholpen',
    minFlares: 3,
  ...
  {
    id: 'trusted',
    name: 'Vertrouwde Buur',
    emoji: '⭐',
    description: 'Altijd betrouwbaar',
    minFlares: 10,
    color: 'text-blue-400',
  ...
  {
    id: 'guardian',
    name: 'Buurtbeschermer',
    emoji: '🛡️',
    description: 'Waakt over de buurt',
    minFlares: 25,
  ...
  },
  {
    ...
    name: 'Buurttopper',
    emoji: '🏆',
    description: 'Een uitzonderlijke helper',
    minFlares: 50,
  ...
  },
  {
    ...
    name: 'Buurtheld',
    emoji: '👑',
    description: 'Een echte pijler van de buurt',
    minFlares: 100,
    color: 'text-rose-400',
