...
import type { LanternTransaction } from '@/lib/types'
...
export function WalletView() {
  ...
  // Transform raw transactions to the LanternTransaction format
  const transactions: LanternTransaction[] = rawTransactions.map((t: Record<string, unknown>) => ({
    id: t.id as string,
    from: (t.type as string) === 'transfer_in' ? 'neighbor' : authUser.id,
    to: (t.type as string) === 'transfer_out' ? 'neighbor' : authUser.id,
